...
import { createCategory, createNotification, deleteCategory, deleteNotification, editCategory, editSingleUser, editSingleUserCapsule, getCategories, getSingleUserCapsule, getSingleUserWithCapsules, getUsers } from '../controllers/admin';
